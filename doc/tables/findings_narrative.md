...
El análisis cubre 3 configuración(es) con datos (Baseline, Sequential, SR (r=1)), un total de 1195 ejecuciones válidas y los benchmarks HE.
...
En las configuraciones de self-reflection, el número medio de revisiones es 0.39 (mediana 0); el 61.14% de las ejecuciones aprueba sin necesidad de ninguna revisión (r=0), lo que sugiere que el revisor sólo interviene en una fracción acotada de los problemas.
